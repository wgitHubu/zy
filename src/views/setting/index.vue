    ...
    <el-card shadow="always">
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="新增角色" name="first">
          <el-row>
            <el-button v-isHas="'role-add'" type="primary" style="margin-left:10px" size="small" @click="addRole">新增角色</el-button>
          </el-row>
          <!-- 表格 -->
          <el-table
            v-loading="loading"
          ...
          >
            ...
            <el-table-column align="center" label="操作" width="240px">
              <template slot-scope="{row}">
                ...
                <el-button v-isHas="'role-a'" size="small" type="primary" @click="edit(row)">编辑</el-button>
                <el-button v-isHas="'role-b'" size="small" type="danger" @click="delRow(row.id)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
          <!-- 分页 -->
