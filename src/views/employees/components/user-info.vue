      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <!-- 放置上传图片 -->
            <upload-img ref="uploadAvater" :default-url="employeesAvatar" @on-success="uploadAvaterSuccess" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <upload-img ref="employeesPic" :default-url="employeesPic" @on-success="uploademployeesPicSuccess" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    uploadAvaterSuccess(data) {
      this.userInfo.staffPhoto = data.imgUrl
    },
    uploademployeesPicSuccess(data) {
